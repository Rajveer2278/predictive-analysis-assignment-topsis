# Topsis-Rajveer Singh-102203195

Assignment(UCS654)<br>
Submitted by: Rajveer Singh<br>
Roll no: 102203195<br>
Group: 3C15
...
pip install Topsis-RajveerSingh-102203195
...
```
python -m Topsis_RajveerSingh_102203195 data.xlsx "1,1,1,1,1" "+,-,+,-,+" output.csv
```
